function autoenc = trainAutoencoder520(X, varargin)
...
paramsStruct  = Autoencoder520.parseInputArguments(varargin{:});
autonet = Autoencoder520.createNetwork(paramsStruct);
autoenc = Autoencoder520.train(X, autonet, paramsStruct.UseGPU);
end