classdef(Sealed, InferiorClasses = {?network}) Autoencoder520
    ...
    methods(Static, Hidden)
        function inputParametersStruct = parseInputArguments(varargin)
            ...
            parse(p, varargin{:});
            p.Results.EncoderTransferFunction
        ...
        function net = createNetwork(paramsStruct)
            ...
            paramsStruct.EncoderTransferFunction
